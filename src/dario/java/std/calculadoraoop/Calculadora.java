...
public class Calculadora {
    ...
    public static void main(String[] args)  {
        ...
        while (true) {
            ...
            do {
                ...
                } catch (TipoOperacionIncorrectaException e) {
                    System.out.println("operac incorrecta" + e.getTipoOperacion());
                    throw new ErrorDeSistemaException(e);
                }
    ...
    private static Operacion obtenerOperacion(String tipoOperacion)
            throws TipoOperacionIncorrectaException{
